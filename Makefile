...
# operating system:  Linux 3.1.1-1-ARCH x86_64 [ELF] (3.1.1)
# libc:	(6.14.1)
# binutils:	(221)
...
TCLIBDIR =
      ...
      CURRENT_DIR = .
            ...
            IMAKE = imake  -I$(MCONFIGDIR) -DMotifProjectRoot=$(MPROJECTROOT)
           DEPEND = gccmakedep
        MKDIRHIER = mkdir -p
          REVPATH = revpath
    EXPORTLISTGEN =
...
LINTXTRAP = $(LINTLIBDIR)/llib-lXTrap.ln
  ...
  XRENDERPRELOADPATTERN = libXrender.so.?
    XFONTPRELOADPATTERN = libXfont*.so.?
              ...
              MTOP = $(TOP)
TOP_MOTIF_INCLUDES = -I$(MPROJECTROOT)/include
  ...
  GENERALSRCBIN = $(TESTSRC)/General/bin
   ...
   MPROJECTROOT = /usr
     MCONFIGDIR = $(MPROJECTROOT)/lib/X11/config
...
XMULIB = $(XMULIBONLY) $(XTOOLLIB) $(XLIB)
    ...
    USRLIBDIRPATH = $(MPROJECTROOT)/lib:$(USRLIBDIR)
        LDPRELIBS = -L$(MPROJECTROOT)/lib -L$(USRLIBDIR)  $(INSTALLED_LIBS)
...
install:: rtl
	...
	$(INSTALL) $(INSTALLFLAGS) $(INSTPGMFLAGS)  rtl $(DESTDIR)$(BINDIR)/rtl
