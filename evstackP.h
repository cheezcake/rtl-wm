/*
#ifndef lint
static char sccs_id[] = "@(#)evstackP.h	5.5 9/1/88  Siemens Corporate Research and Support, Inc.";
#endif
*/
...
/* 
  ...
  evstackP.h: data structure definitions for evstack package
*/
