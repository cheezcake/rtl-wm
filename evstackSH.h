/*
#ifndef lint
static char sccs_id[] = "@(#)evstackSH.h	5.5 9/1/88  Siemens Corporate Research and Support, Inc.";
#endif
*/
...
/* 
  ...
  evstackSH.h: shared functions and types for evsave package
*/
